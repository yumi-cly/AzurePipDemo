...
var environmentMap = { 
                        staging: 'apim-shared-ecp-staging-westus2-01'
                      }
var productName = 'CORPSCLMMCAAPIProduct'
var serversUrl = 'https://api.corp-staging.premera.com'
var serviceUrl = 'https://app-clm-mca-st-westus2-${sequenceNumber}.ase-ecp-staging-aseilbv3-02.appserviceenvironment.net/api/ClmListener' // Backend path
