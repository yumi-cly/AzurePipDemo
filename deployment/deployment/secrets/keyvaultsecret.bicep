...
module secret_roleAssignments '../modules/role-assignment.bicep' = [for (roleAssignment, index) in roleAssignments: {
...
@description('The Uri of the current version of the secret.')
